...
output_directory = "MIT_output/tables"
...
for n_queries in n_query_list:
    ...
    with open("{}/table_{}.txt".format(output_directory, n_queries), "w") as f:
        f.write("Maximum number of queries: {}, dimension: {}\n\n".format(max_n_queries, dimension))
    print("Maximum number of queries: {}, dimension: {}\n".format(max_n_queries, dimension))

    results_df = pd.DataFrame(columns=columns)

    for separator_name, strategy_name in algorithms:

        input_directory = "MIT_output/logs/{}+{}".format(separator_name, strategy_name)
